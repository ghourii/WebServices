...
namespace PDWPAu.Controllers
{
    public class PDWPAuController : ApiController
    {
        //private PDWP_WorkingPaper_DBEntities db = new PDWP_WorkingPaper_DBEntities();
        //private string _host;

        //public PDWPAuController()
        //{
        ...
        //        if (isValid)
        //        {
        //            var list = new PDWPRepository().GetCalendarData(month, year, province, _host);
        //            model.status = "200";
